...
public class ConcreteCoordinate implements Coordinate {
	...
	@Override
	public Direction getNearDirection(Coordinate coordinate) {
	...
	public boolean inHorizontal(Coordinate coordinate) {
		...
		return this.row == ((ConcreteCoordinate) coordinate).row && this.column + 1 == ((ConcreteCoordinate) coordinate).column ;
	}
	...
	public boolean inVertical(Coordinate coordinate) {
		...
		return this.column  == ((ConcreteCoordinate) coordinate).column && this.row + 1 == ((ConcreteCoordinate) coordinate).row ;
	}

	@Override
	public boolean inMainDiagonal(Coordinate coordinate) {
		return this.row + 1 == ((ConcreteCoordinate) coordinate).row && this.column + 1 == ((ConcreteCoordinate) coordinate).column;
	}
